...
@section('content')
<h1 class="text-center">List Musics</h1>
<div class="row justify-content-between mb-sm-5">
    <div class="col-sm-2 row ps-1">
        <a href="{{ route('musics.create')}}"><button class="btn btn-primary col-12">Create</button></a>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $p->author->name}}</td>
                <td>
                    <a href="{{ route('musics.edit', ['id' => $p->id ])}}" class="btn btn-primary">
    ...
    function showSwal(msgAction, msg) {
        Swal.fire({
            ...
            if (msgAction == 'success') {
                window.location.assign("/productsi");
            }
        })
    }
